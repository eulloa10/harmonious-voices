...
def seed_messages():
    ...
    demo_message_3 = Message(
        user_id=3, channel_id=2, content='test message 3')
    demo_message_4 = Message(
        user_id=3, channel_id=3, content='test message 4')
    demo_message_5 = Message(
        user_id=3, channel_id=4, content='test message 5')
    demo_message_6 = Message(
        user_id=2, channel_id=5, content='test message 6')
    demo_message_7 = Message(
        user_id=3, channel_id=6, content='test message 7')
    demo_message_8 = Message(
        user_id=4, channel_id=8, content='test message 8')
    demo_message_9 = Message(
        user_id=5, channel_id=8, content='test message 9')
    demo_message_10 = Message(
        user_id=1, channel_id=7, content='test message 10')
    demo_message_11 = Message(
        user_id=2, channel_id=6, content='test message 11')
    demo_message_12 = Message(
        user_id=3, channel_id=5, content='test message 12')
