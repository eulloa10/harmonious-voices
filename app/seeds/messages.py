...
def seed_messages():
    ...
    demo_message_6 = Message(
        user_id=2, channel_id=1, content='test message 6')
    demo_message_7 = Message(
        user_id=3, channel_id=1, content='test message 7')
    demo_message_8 = Message(
        user_id=4, channel_id=1, content='test message 8')
    demo_message_9 = Message(
        user_id=5, channel_id=1, content='test message 9')
    demo_message_10 = Message(
        user_id=1, channel_id=1, content='test message 10')
    demo_message_11 = Message(
        user_id=2, channel_id=1, content='test message 11')
    demo_message_12 = Message(
        user_id=3, channel_id=1, content='test message 12')
    demo_message_13 = Message(
        user_id=4, channel_id=1, content='test message 13')
