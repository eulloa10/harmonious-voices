...
def seed_user_servers():
    demo = ServerMember(user_id=1, server_id=1)
    demo2 = ServerMember(user_id=1, server_id=2)
    demo3 = ServerMember(user_id=2, server_id=2)
    demo4 = ServerMember(user_id=2, server_id=3)
    demo5 = ServerMember(user_id=3, server_id=3)
    demo6 = ServerMember(user_id=3, server_id=4)
    demo7 = ServerMember(user_id=4, server_id=4)
    demo8 = ServerMember(user_id=4, server_id=5)
    demo9 = ServerMember(user_id=5, server_id=5)
